...
<div class="container">
    <div class="card">
        ...
        <div class="card-body">
            <form class="form-horizontal" action="<?= base_url('auth/login')?>" method="post">
                ...
                <div class="form-group">
                    <div class="input-group mb-3">
                        ...
                        <input type="password" class="form-control" name="password" id="" placeholder="Password"><br>
                    </div>
                </div>
                <div class="form-group">
            ...
            <p>Belum buat akun? <a href="<?= base_url('auth/register')?>">Klik Disini Untuk Sign Up Admin</a></p>
        </div>
        </div>
    </div>
</div>
