...
<body>
	...
	<div class="row">
		...
		<div class="col-md-10">
			...
			<?= form_open_multipart('UserController/create', ['class'=>'form-horizontal','was-validated']) ?>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" name="ttl" placeholder="mm/dd/yyyy" value="<?= set_value('ttl') ?>">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" name="umur" placeholder="umur" value="<?= set_value('umur') ?>">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" name="asalSekolah" placeholder="asal sekolah" value="<?= set_value('asalSekolah') ?>">
				</div>
			</div>
